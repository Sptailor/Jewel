...
async function main() {
  ...
  const products = [
    ...
    },
    {
      ...
      featured: false,
      images: [
        { url: 'https://images.unsplash.com/photo-1758995115518-26f90aa61b97?w=800&h=800&fit=crop', alt: 'Gold Pendant Necklace', order: 0 },
      ],
      variants: [
    ...
    // Bracelets
    {
      ...
      featured: true,
      images: [
        { url: 'https://images.unsplash.com/photo-1663568675454-ecd65012d8f0?w=800&h=800&fit=crop', alt: 'Diamond Bracelet', order: 0 },
      ],
      variants: [
    ...
    },
    {
      ...
      featured: false,
      images: [
        { url: 'https://images.unsplash.com/photo-1728381031272-ba3f537feadd?w=800&h=800&fit=crop', alt: 'Gold Bangle', order: 0 },
      ],
      variants: [
    ...
    },
    {
      ...
      featured: false,
      images: [
        { url: 'https://images.unsplash.com/photo-1724896728449-fae038f93e59?w=800&h=800&fit=crop', alt: 'Silver Cuff Bracelet', order: 0 },
      ],
      variants: [
